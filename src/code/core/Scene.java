...
public abstract class Scene {
  ...
  public static RigidBody[] s5() {
    return new RigidBody[] {
      new Sphere(new Vector3(0, 0, 5), 1, new Material(new Vector3(255, 1, 128), 0f, new Vector3())),
      new Sphere(new Vector3(0, 0, 2), 0.3, new Material(new Vector3(1, 128, 255), 0f, new Vector3())),
      new Sphere(new Vector3(1, 0, 3), 0.6, new Material(new Vector3(128, 255, 1), 0f, new Vector3())),
      new Sphere(new Vector3(4000, 10000, 1000), 80, new Material(new Vector3(255, 255, 255), 0f, new Vector3(Integer.MAX_VALUE))),
