...
public abstract class Scene {
  public static RigidBody[] s1() {
    RigidBody[] s = {
      ...
      new Sphere(new Vector3(2000, 10000, 1000), 80, new Material(new Vector3(255, 255, 255), 0f, new Vector3(Integer.MAX_VALUE))),
  ...
  public static RigidBody[] s4() {
    RigidBody[] s = {
      new Sphere(new Vector3(-1, -1, 2.5), 0.1, new Material(new Vector3(255, 255, 255), 0f, new Vector3(0, 5, 10))),
      new Sphere(new Vector3(2000, 10000, 1000), 80, new Material(new Vector3(255, 255, 255), 0f, new Vector3(Integer.MAX_VALUE))),
      new Map(new Vector3(0, -28, 0), new Material(new Vector3(150, 150, 150), 0f, new Vector3()))
    };
    return s;
  };
  ...
  public static RigidBody[] s5() {
    RigidBody[] s = {
      new Cube(new Vector3(0, 0, 5), 1, new Material(new Vector3(255, 1, 128), 0f, new Vector3(0.5))),
      new Cube(new Vector3(0, 0, 2), 0.3, new Material(new Vector3(1, 128, 255), 0f, new Vector3(0.5))),
      new Cube(new Vector3(1, 0, 3), 0.6, new Material(new Vector3(128, 255, 1), 0f, new Vector3(0.5))),
      new Sphere(new Vector3(2000, 10000, 1000), 80, new Material(new Vector3(255, 255, 255), 0f, new Vector3(Integer.MAX_VALUE))),
